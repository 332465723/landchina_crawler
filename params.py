...
class CrawlerHeaders(object):
    ...
    common_cookie = {
        u'ASP.NET_SessionId': u'yfvojnn14kmdfmmk3rcm02tc',
        u'Hm_lvt_83853859c7247c5b03b527894622d3fa': u'1560425088',
        u'Hm_lpvt_83853859c7247c5b03b527894622d3fa': u'1560432160',
        u'srcurl': u'687474703a2f2f7777772e6c616e646368696e612e636f6d2f64656661756c742e617370783f74616269643d32363126776d677569643d32306161653864632d346130632d346166352d616564662d63633135336562366566646626703d',
        u'yunsuo_session_verify': u'0db5f41600a51f21a59422bf95fd1101',
        u'security_session_mid_verify': u'02923d623cd852eadb24439d2e392be7'
    }
    ...
    def init_cookie(self):
        ...
        ret = requests.request('GET', url, headers=self.common_headers)
